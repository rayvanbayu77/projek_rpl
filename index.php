...
<html lang="en">
  ...
  <label class="kategori" for="kategori"><strong>Kategori Pertanyaan :</strong></label>
  ...
  <div class="qst-list">
    <p>
      ...
      <?php if (!empty($row['gambar'])) : ?>
        <img src="uploads/<?= $row['gambar'] ?>" alt="Gambar Pertanyaan" style="max-width: 300px; max-height: 300px; margin-top: 10px;"><br>
      <?php endif; ?>
