...
if(isset($_POST['submit_edit'])) {
  ...
  $password =md5($_POST['password']);
	...
	$sql = $conn->query("UPDATE users SET email = '$email', password = '$password' WHERE id = $id") or die(mysqli_error($conn));
	if($sql) {
		echo "
     ...
     <div class="row">
        ...
        <div class="greets">
          ...
          <form action="" method="POST" >
            ...
            <br>
            <p class="h5 my-05 me-md-auto fw-normal">Password</p>
            <div class="input-group">
              <input type="text" class="form-control" placeholder="password" name="password" value="<?= $editSql['password']?>">
            </div>
            <br>
            <div class="mb-3">
